...
| Package | Description |
|---------|-------------|
| `@open-measure/capi` | Server-side conversion API for Open Measure |
| `@open-measure/cli` | Non-interactive CLI for Open Measure |
| `@open-measure/dest-ga4` | Google Analytics 4 destination for Open Measure |
| `@open-measure/dest-gtm` | Google Tag Manager dataLayer destination for Open Measure |
| `@open-measure/dest-meta` | Meta Pixel destination for Open Measure |
| `@open-measure/dest-posthog` | PostHog destination for Open Measure |
| `@open-measure/mcp` | MCP server for AI-assisted analytics integration |
| `@open-measure/next` | Next.js integration for Open Measure |
| `@open-measure/qa` | QA toolkit for Open Measure |
| `@open-measure/react` | React hooks and provider for Open Measure |
| `@open-measure/spec` | JSON schemas and event specifications for Open Measure |
| `@open-measure/web` | Core analytics tracker with plugin architecture |
